...
@Transactional(value = "transactionManagerWeb")
public class HibernateWeb extends HibernateDaoSupport {

	protected Logger log = Logger.getLogger(getClass().getName());

	@Autowired
	public void annyMethodName(@Qualifier("sessionWeb") SessionFactory sessionFactory) {
